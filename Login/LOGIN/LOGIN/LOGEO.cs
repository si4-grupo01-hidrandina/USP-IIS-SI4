    ...
    public partial class LOGEO : Form
    {
        ...
        public void INICIOSESION (string usuario, string password)
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("SELECT Nombre, TipoUsuario FROM Usuarios WHERE Usuario =@Usuario AND Password = @Password ",con);
                ...
                if (dt.Rows.Count == 1) {
                    ...
                    MessageBox.Show("USUARIOY/O CONTRASEÑA INCORRECTA");
                }
